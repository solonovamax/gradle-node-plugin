 ...
 */
abstract class CorepackNpmInstallTask : CorepackNpmTask() {
    @get:Internal
    ...
    init {
        ...
        description = "Install node packages using NPM (via Corepack)."
    ...
    protected fun getNodeModulesPackageLock(): File? {
        // we have no way to check if we're using legacy npm
        // if (isLegacyNpm()) {
        //     return null
        // }
    ...
    companion object {
        const val NAME = "corepackNpmInstall"
    }
}
