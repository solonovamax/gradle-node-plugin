...
class CorepackNpmProxy_integTest extends AbstractIntegTest {
    ...
    def 'install packages using proxy (#gv.version)'() {
        ...
        copyResources("fixtures/npm-corepack-proxy/")
    ...
    def 'install packages using pre-configured proxy (#gv.version)'() {
        ...
        def result = buildWithEnvironment(env, "corepackNpmInstall")
